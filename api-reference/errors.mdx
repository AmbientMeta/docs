...
| `email_taken` | 409 | Account with this email already exists | Log in or use a different email |
| `billing_not_configured` | 400 | Billing is not set up on this instance | Contact support |
| `no_billing_account` | 400 | No Stripe customer for this org | Contact support |
| `billing_error` | 502 | Stripe communication error | Try again or contact support |
| `service_unavailable` | 503 | Service is still starting | Retry after a short wait |
